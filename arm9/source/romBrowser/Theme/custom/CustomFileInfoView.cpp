...
void CustomFileInfoView::SetFirstLineAsync(TaskQueueBase* taskQueue, const char* firstLine, bool /*ellipsis*/)
{
    if (taskQueue)
...
void CustomFileInfoView::SetFirstLineAsync(TaskQueueBase* taskQueue, const char16_t* firstLine, u32 length, bool /*ellipsis*/)
{
    if (taskQueue)
...
void CustomFileInfoView::SetSecondLineAsync(TaskQueueBase* taskQueue, const char16_t* secondLine, u32 length)
{
    if (taskQueue)
...
void CustomFileInfoView::SetThirdLineAsync(TaskQueueBase* taskQueue, const char16_t* thirdLine, u32 length)
{
    if (taskQueue)
...
void CustomFileInfoView::SetFileNameAsync(TaskQueueBase* taskQueue, const TCHAR* fileName, bool useAsTitle)
{
...
void CustomFileInfoView::PrepareFileNameScrollIfNeeded(const BannerView::LayoutConfig& cfg)
{
...
void CustomFileInfoView::UpdateFileNameScroll(const BannerView::LayoutConfig& cfg)
{
...
void CustomFileInfoView::ApplyLayoutFonts(const BannerView::LayoutConfig& cfg)
{
